...
void fill_map(t_data *data)
{
	...
	//	exit(1);
	//data->l_texture.addr = (int *)mlx_get_data_addr(data->l_texture.img,&data->l_texture.bpp,&data->l_texture.line_length,&data->l_texture.endian);
...
//		exit(1);
//	data->r_texture.addr =(int *) mlx_get_data_addr(data->r_texture.img,&data->r_texture.bpp,&data->r_texture.line_length,&data->r_texture.endian);
	printf("hey");
	...
	if (!data->b_texture.img)
		exit(1);
	data->b_texture.addr = (int *)mlx_get_data_addr(data->b_texture.img,&data->b_texture.bpp,&data->b_texture.line_length,&data->b_texture.endian);
...
//		exit(1);
//	data->f_texture.addr = (int *)mlx_get_data_addr(data->f_texture.img,&data->f_texture.bpp,&data->f_texture.line_length,&data->f_texture.endian);
